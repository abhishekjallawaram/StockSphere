                ...
                <div className="flex-1 overflow-hidden p-9">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4  ">
                        ...
                        <div className="md:col-span-1 pr-8">
                            ...
                            <Card className="flex flex-col h-auto  h-[580px] mb-4 ml-2 w-[600px]"> {/* Adjust height as needed */}
                                {/* <CardTitle className="text-xl p-6 text-left">Stock Data</CardTitle> */}
                                <TableHeader className="items-center mt-9  ">
                                    <TableRow>
                                        <TableHead className="font-mono  transition-colors hover:text-primary  pl-16 w-1/4 ">Company Name</TableHead>
                                        <TableHead className="  font-mono w-1/4 pl-16  transition-colors hover:text-primary">Ticker</TableHead>
                                        <TableHead className="  font-mono w-1/4 pl-9  transition-colors hover:text-primary">Closed Price</TableHead>
                                        ...
                                        <TableHead className=" font-mono  w-1/4 pl-12  transition-colors hover:text-primary">Action</TableHead>
                                    </TableRow>
                                </TableHeader>

                                <ScrollArea  className="h-[580px] mt-10 mb-4 ml-2 w-[580px] rounded-md border p-4">
                                        ...
                                        <TableBody className="" >
                                            {stockData.map((stock, index) => (
                                                <TableRow key={index}>
                                                    ...
                                                    <TableCell><Dialog>
                                                        <DialogTrigger className=' transition-colors hover:text-primary' >Buy</DialogTrigger>
                                                        <DialogContent>
                                                            <DialogHeader>
  ...
  <div className="flex flex-col space-y-4 p-4">
    ...
    <div className='flex justify-between items-center'>
      ...
      <CardFooter className="flex flex-col gap-4">
        <Button className="w-full" type="submit" >BUY</Button>
      </CardFooter>
    </Card>
                                                                <DialogDescription>
                        ...
                        <h1 className="text-2xl text-left font-bold font-mono text-center md:text-left transition-colors hover:text-primary"> Your Stocks : </h1>
                            <div className="md:col-span-1 md:mt-8 max-h-12 ml">
                                <Card className="flex-grow w-[300px] rounded-md ml-1 mb-9"> {/* Adjust max-width as needed */}
                                    ...
                                    <ScrollArea className="h-[160px] mb-4 ml-3 w-[270px] rounded-md border p-4 bg-white "> {/* Set max height */}
                                        <CardContent>
                                            <TableBody className="items-center text-black text-center font-bold" >
                                                {cstockData.map((cstockData, index) => (
                                                    <TableRow key={index} >
                                                        <TableCell className="text-black">{cstockData.stock_ticket}</TableCell>
